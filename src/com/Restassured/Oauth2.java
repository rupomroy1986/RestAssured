...
/*System.setProperty("webdriver.chrome.driver", "C:\\API TESTING CONTINUE\\chromedriver.exe");
...
driver.findElement(By.cssSelector("input[type='email']")).sendKeys("roy.rupom6@gmail.com");		
driver.findElement(By.cssSelector("input[type='email']")).sendKeys(Keys.ENTER);
Thread.sleep(5000);
driver.findElement(By.cssSelector("input[type='password']")).sendKeys("silcharrups1@");		
driver.findElement(By.cssSelector("input[type='email']")).sendKeys(Keys.ENTER);
Thread.sleep(5000);
...
//2nd step
//here url encoding is used to tell rest assured not to do url encoding for special characters
